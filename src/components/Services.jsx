    ...
    <Section id="how-to-use">
      <div className="container">
        <Heading
          ...
          text="Brainwave unlock the potential if AI-powered applications"
        />
        <div className="relative">
          <div
            alt="1st Robot Section"
          ...
          >
            ...
            <Generating className="absolute left-4 right-4 bottom-4 border-n-1/10 border lg:left-1/2 lg:right-4 lg:bottom-8 lg:-translate-x-1/2" />
          </div>
          <div
            alt="2nd Robot Section"
          ...
          >
            ...
            <div
              alt="3nd Robot Section"
              className="p-4 bg-n-7 rounded-3xl overflow-hidden lg:min-h-[46rem]"
            >
              <div alt="Video Generation" className="py-12 px-4 xl:px-8">
